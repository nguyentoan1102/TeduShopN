...
namespace TeduShop.Service
{
    ...
    public class FunctionService : IFunctionService
    {
        ...
        public bool CheckExistedId(string id) => _functionRepository.CheckContains(f => f.ID == id);

        public Function Create(Function function) => _functionRepository.Add(function);
        ...
        public IEnumerable<Function> GetAllWithParentID(string parentId) => _functionRepository.GetMulti(x => x.ParentId == parentId);

        public IEnumerable<Function> GetAllWithPermission(string userId) => _functionRepository.GetListFunctionWithPermission(userId).OrderBy(x => x.ParentId);
